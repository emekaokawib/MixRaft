 ...
 * This file demonstrates how to integrate Mixraft with a web frontend
 */

// For React/Vue/Angular applications
export class MixraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MixraftClient(provider, contractAddress);
